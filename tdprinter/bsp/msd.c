        ...
        /* Analyze CSD */
        {
            ...
            else /* SD CSD Analyze. */
            {
                ...
                else if(CSD_STRUCTURE == 1)
                {
                    ...
                    /* memory capacity = (C_SIZE+1) * 512K byte = cap(KByte) */
                    card_capacity = (C_SIZE + 1) / 2; /* unit : Mbyte , Mbyte/512kbyte=2 */
                    msd->geometry.sector_count = card_capacity * 2048; /* sector(512byte)= capacity(Mbyte)*1024*2 */
